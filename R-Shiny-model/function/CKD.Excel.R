...
CKD_model <- function(analysis, input_timehorizon, 
  ...
  CPItable <- read_csv("data/CPI.csv", col_types = cols(Year = col_integer(), 
                                                        CPI = col_double()))
  CPItable$IFactor <- CPItable$CPI[CPItable$Year==2022] / CPItable$CPI
  
  infl_to_22 <- function(cost,year,to_year=2022){
  ...
  cost_ckdcvd$Mean <- mapply(infl_to_22, cost = cost_ckdcvd$Mean, year = cost_ckdcvd$Year)
  cost_ckdcvd$SE <- mapply(infl_to_22, cost = cost_ckdcvd$SE, year = cost_ckdcvd$Year)
  ...
  c_ms_vectors_input <- lapply(c_ms_vectors_input, function(x) {
    x["Mean"] <- infl_to_22(cost = x["Mean"], year = x["Year"])
    x["SE"] <- infl_to_22(cost = x["SE"], year = x["Year"])
    return(x[c("Mean", "SE")])
  })
  ...
  c_sta_input <- c("Mean" = infl_to_22(cost=102.52,year=2021), 
                   "Lower" = infl_to_22(cost=41.18,year=2021), 
                   "Upper" = infl_to_22(cost=163.85,year=2021))
  ...
  c_sta_diabetes_input <- c("Mean" = infl_to_22(cost=9600,year=2017), "SE" = NA)
  c_sta_mae_input <- c("Mean" = infl_to_22(cost=178,year=2019), "SE" = NA)
  c_sta_sae_input <- c("Mean" = infl_to_22(cost=7033,year=2019), "SE" = NA)
  ...
  c_sta_live <- SA_gamma(vec.mean_l_u = c_sta_input, n = 6)[analysis] # gamma distribution, n = 6
  ...
  c_BP_input <- c("Mean" = 229.5, "SE" = 229.5 * 0.2)
  ...
  c_BP_itae_input <- c("Mean" = infl_to_22(cost=110.28,year=2019), "SE" = infl_to_22(cost=110.28,year=2019) * 0.1)
  c_BP_sae_input <- c("Mean" = infl_to_22(cost=147.76,year=2019), "SE" = infl_to_22(cost=147.76,year=2019) * 0.1)
  ...
  c_asp_input <- c("Mean" = 3.39, "SE" = 3.39 * 0.1)
  p_asp_mb_input <- c("Mean" = 1.39/1000, "Lower" = 0.7/1000, "Upper" = 2.28/1000)
  c_asp_mb_input <- c("Mean" = infl_to_22(cost=13093,year=2018), "SE" = infl_to_22(cost=13093,year=2018) * 0.1)
  ...
  UAR_sglt <- 0
  effect_year_UAR <- 3
  c_sglt_input <- c("Mean" = 4192, "SE" = 4192 * 0.1)
  ...
  # US 2020 life tables, Verified by Shawn Warner on 18/7/23. https://www.cdc.gov/nchs/data/nvsr/nvsr71/nvsr71-01.pdf
  LT <- read_csv("data/US_2022_Life_tables.csv",
  ...
  # Cause specific mortality, US life tables 2019, Verified by Shawn Warner on 18/7/23. https://www.cdc.gov/nchs/data/nvsr/nvsr70/nvsr70-09-508.pdf
  CSM <- read_csv("data/Cause_specific_mortality_US_2022.csv", 
